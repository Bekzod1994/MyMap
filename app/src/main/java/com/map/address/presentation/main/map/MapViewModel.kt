...
import com.map.address.domain.usecases.SaveGeoUseCase
...
class MapViewModel @Inject constructor(
    ...
    private val _onSaveToast = Channel<Boolean>()
    val showToast = _onSaveToast.receiveAsFlow()
